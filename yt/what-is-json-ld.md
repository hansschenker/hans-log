...
date: 2026-07-29
videoId: vioCbTo3C-4
url: https://www.youtube.com/watch?v=vioCbTo3C-4
type: summary
tags: [yt, json-ld, linked-data, semantic-web, rdf, knowledge-graphs]
language: en
---
...
- [[owl-web-ontology-language]] — OWL/ontologies: the schema/reasoning layer above RDF that JSON-LD feeds into
- [[knowledge-graphs-10-knowledge-representation-with-graphs]] — graphs, triples, Linked Data / Web of Data
