---
slug: protege-author-matthew-horridge
...
- Relevant to the current ontology thread because the **pizza tutorial** being worked through ([[protege-pizza]], [[build-ontology-in-protege-pizzaowl-01-opening-introduction]]) descends directly from Horridge's original OWL/Protégé guide.
...
- [[protege-pizza]] — the pizza tutorial his original guide seeded
- [[build-ontology-in-protege-pizzaowl-01-opening-introduction]] — companion video series
- [[ontology-tool-protege]] — the Stanford Protégé editor
- [[understanding-owl-2]] — the OWL 2 language his tooling targets
