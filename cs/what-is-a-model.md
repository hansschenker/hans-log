...
- [[reactiveconf-2016-andr-staltz-visualizing-the-data-flow]] — Cycle.js as the continuous/streaming corner of the triad; data flow made visible via the stage-observes-world cycle
