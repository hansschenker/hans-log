...
- [[rxjs-observable-taxonomy]] — the semantics layer this grammar names; cold/hot ⟂ unicast/multicast
- [[rxjs-switchmap-deep-dive]] — the `switch` strategy's cancellation policy in practice
- [[rxjs-74-subjects]] — multicasting, the machinery behind `shareLatest`
- [[rxjs-heritage]] — where the operator names came from in the first place
