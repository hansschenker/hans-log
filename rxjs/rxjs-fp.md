...
- This and [[rxjs-operator-renaming]] are **the same thesis approached from opposite ends**. Both
...
- [[rxjs-operator-renaming]] — the same design thesis as an alias layer over official RxJS
- [[rxjs-observable-taxonomy]] — the cold/hot ⟂ unicast/multicast semantics this core implements
- [[rxjs-74-subjects]] — Subject and multicasting, the only hot thing in the library
- [[rxjs-switchmap-deep-dive]] — inner-subscription cancellation, where the early-linking bug lived
