...
description: "chunking strategies: fixed-size, semantic, hierarchical small-to-big"
resource: ./ai-claude-rag-architecture.txt
...
- [Docling an intro to LLM 4](./ai-docling-intro-llm-4.md) — Docling prepares documents for exactly this ingestion/chunking step
