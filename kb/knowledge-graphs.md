...
description: knowledge graphs, semantic web, RDF/OWL, Protege ontology engineering
tags: [json-ld, knowledge-graphs, linked-data, ontology, owl, rdf, semantic-web, turtle]
timestamp: 2026-08-15
---

The OpenHPI Knowledge Graphs course (Harald Sack) plus the hands-on Protege/OWL track — RDF, Turtle, JSON-LD, and ontology engineering.
