...
description: OWL 2 ontology language for the semantic web
resource: https://www.youtube.com/watch?v=CWXiNNLuJow
tags: [ontology, owl, knowledge-graphs, semantic-web, description-logic]
...
- [Knowledge Graphs - 1.0 Knowledge Representation with Graphs](./knowledge-graphs-10-knowledge-representation-with-graphs.md)
- [Knowledge Graphs - 0.0 Lecture Overview](./knowledge-graphs-00-lecture-overview.md)
- [ytl-knowledge-graphs](./ytl-knowledge-graphs.md)
