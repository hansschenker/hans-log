...
description: Luis Atencio on persistent data flows with RxJS + PouchDB
resource: https://medium.com/@luijar/rxjs-pouchdb-persistent-data-flows-480f503ee41f
...
- **Concurrency policy matters for writes** — `concatMap()` preserves order for dependent/sequential
  ...
  choice from [RxJS Heritage — from LINQ and Rx.NET](./rxjs-heritage.md)).
...
- Companion to the same-day [Offline-First Apps with Angular, Ionic & CouchDB](./couchdb-repo.md) offline-first exploration and Atencio's
  [Kleisli Compositions in JavaScript](./kleisli-compositions-js.md) on functional composition.

## Related

- [RxJS Heritage — from LINQ and Rx.NET](./rxjs-heritage.md) — where the four flatten/concurrency policies come from
- [Kleisli Compositions in JavaScript](./kleisli-compositions-js.md) — Luis Atencio on functional composition
- [Offline-First Apps with Angular, Ionic & CouchDB](./couchdb-repo.md) — offline-first Angular/Ionic/CouchDB sample
