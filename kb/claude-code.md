...
type: topic
title: Claude Code
description: working with Claude and Claude Code — courses, workflows, skills, models
tags: [claude, claude-code, claude-md, skills]
timestamp: 2026-08-15
---

Claude Code as daily project manager: the Master Claude Code course notes, real-world workflows from Anthropic engineers, and skills/plugins.
