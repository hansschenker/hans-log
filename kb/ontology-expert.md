...
description: Harald Sack's presentation slides on knowledge graphs & semantic web
resource: https://github.com/lysander07/Presentations.git
...
- [Protégé Pizza Tutorial (yasenstar/protege_pizza)](./protege-pizza.md) — hands-on OWL ontology building in Protégé (the *how*)
- [Matthew Horridge (Protégé / OWL author)](./protege-author-matthew-horridge.md) — author of the original Protégé/OWL building guide
- [Turtle (Terse RDF Triple Language)](./turtle-syntax.md) — RDF serialization for the graphs Sack describes
- [What Is a Model](./what-is-a-model.md) — conceptual modeling, upstream of ontology engineering
