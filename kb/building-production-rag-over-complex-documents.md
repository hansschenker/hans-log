...
description: Databricks talk on production RAG over complex docs
resource: https://www.youtube.com/watch?v=dI_TmTW9S4c
...
- [Production RAG with LangChain & Vector Databases – Full Course](./production-rag-with-langchain-vector-databases-full-course.md)
- [rag-fundamentals-and-advanced-techniques](./rag-fundamentals-and-advanced-techniques.md)
