...
description: "95+ formats to markdown: LlamaParse vs Docling vs Mistral OCR"
resource: https://www.youtube.com/watch?v=eHw_6jhK8AM
tags: [rag, docling, llamaparse]
...
- [Multi-modal RAG with Docling: From PDF to Agentic AI Chatbot](./multimodal-rag-with-docling-from-pdf-to-agentic.md) — Docling's image-captioning pipeline in depth
- [RAG Explained in 14 Minutes | 10 RAG Patterns Every AI Engineer Must Know (2026)](./rag-explained-in-14-minutes-10-rag-patterns.md) — where ingestion sits among the 10 RAG patterns
- [Learn RAG Architecture](./ai-claude-rag-architecture.md) — chunking strategies for the markdown output
- [Docling an intro to LLM 4](./ai-docling-intro-llm-4.md) — Docling as LLM preparation
