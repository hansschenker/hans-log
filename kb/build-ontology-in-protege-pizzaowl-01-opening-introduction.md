...
description: Build pizza.owl in Protégé — 49-video hands-on OWL ontology-engineering course (Yasen Zhao); analyzed first video
resource: https://www.youtube.com/playlist?list=PL6DEHvciXKeUx4P32B3hKMK1t6mC8RhsW
tags: [ontology, owl, protege]
...
- [Matthew Horridge (Protégé / OWL author)](./protege-author-matthew-horridge.md)
- [Turtle (Terse RDF Triple Language)](./turtle-syntax.md)
- [ytl-modelling-knowledge](./ytl-modelling-knowledge.md)
