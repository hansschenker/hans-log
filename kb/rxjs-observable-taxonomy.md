...
description: invariant semantics vs. variable execution characteristics vs. style; cold/hot ⟂ unicast/multicast (NotebookLM)
resource: https://notebooklm.google.com/notebook/96fb087f-ed97-49a7-b827-77053c0f2a66
...
- [RxJS Heritage — from LINQ and Rx.NET](./rxjs-heritage.md) — where these push/pull semantics came from (LINQ → Rx.NET → RxJS)
- [#74 Subjects in RxJS  | Understanding Observables & RxJS | A Complete Angular Course](./rxjs-74-subjects.md) — Subject as the Observable+Observer hybrid used for multicasting
- [I switched a map and you'll never guess what happened next - Pete Darwin, Shai Reznik, Mike Brocchi](./rxjs-switchmap-deep-dive.md) — higher-order Observables & flattening/concurrency policy in practice
