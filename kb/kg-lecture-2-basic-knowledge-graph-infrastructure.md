...
description: URIs, RDF, Turtle, RDFS vocabularies, complex structures & RDFS inference (videos 2.1–2.6)
resource: https://www.youtube.com/playlist?list=PLNXdQl4kBgzubTOfY5cbtxZCgg9UTe-uF
tags: [cs, knowledge-graphs, semantic-web, rdf, rdfs, turtle, uri, reasoning]
...
- This is the **hands-keyboard** week: [Knowledge Graphs — Lecture 1: Knowledge Representation with Graphs (1.1–1.7)](./kg-lecture-1-knowledge-representation-with-graphs.md) motivates *why* explicit representation matters; Week 2 is the actual RDF/RDFS/Turtle you'd type.
- The `[Turtle (Terse RDF Triple Language)](./turtle-syntax.md)` note now has a full worked context — prefixes, `;`/`,`, blank nodes, and collections all appear here in Sack's Spock examples.
...
- [Knowledge Graphs — Lecture 1: Knowledge Representation with Graphs (1.1–1.7)](./kg-lecture-1-knowledge-representation-with-graphs.md) — Week 1 (the theory behind this infrastructure)
- [Turtle (Terse RDF Triple Language)](./turtle-syntax.md) — the Turtle serialization detailed here
- [What is JSON-LD?](./what-is-json-ld.md) — JSON-LD, one of the RDF serializations mentioned in 2.2
- [Harald Sack — Presentations (Knowledge Graphs & Ontologies)](./ontology-expert.md) — Harald Sack's broader presentation archive
- [Protégé Pizza Tutorial (yasenstar/protege_pizza)](./protege-pizza.md) — building an OWL ontology (the OWL layer that comes after RDFS)
