...
description: DIKW → triples/graphs → knowledge graphs → Semantic Web stack & Linked Data (videos 1.1–1.7)
resource: https://www.youtube.com/playlist?list=PLNXdQl4kBgzubTOfY5cbtxZCgg9UTe-uF
tags: [cs, knowledge-graphs, semantic-web, ontology, rdf, linked-data, owl, sparql]
...
- [Harald Sack — Presentations (Knowledge Graphs & Ontologies)](./ontology-expert.md) — Harald Sack's presentation archive (same author, broader talks)
- [Protégé Pizza Tutorial (yasenstar/protege_pizza)](./protege-pizza.md) — building an OWL ontology hands-on (the *how*)
- [What is JSON-LD?](./what-is-json-ld.md) — JSON serialization for linked data / RDF
- [Turtle (Terse RDF Triple Language)](./turtle-syntax.md) — Turtle serialization of the RDF triples described here
- [01 Course Introduction - KMST](./01-course-introduction-kmst.md) — parallel academic Semantic Web course intro
