...
description: PDF images captioned via LLM into enriched text, Milvus + LangGraph agent
resource: https://www.youtube.com/watch?v=Uky2eJ25oHY
tags: [rag, docling, multimodal]
...
- [RAG Explained in 14 Minutes | 10 RAG Patterns Every AI Engineer Must Know (2026)](./rag-explained-in-14-minutes-10-rag-patterns.md) — this is patterns 8 (agentic) + 9 (multimodal) implemented concretely
- [Learn RAG Architecture](./ai-claude-rag-architecture.md) — chunking foundations
