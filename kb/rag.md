...
type: topic
title: RAG
description: retrieval-augmented generation — patterns, strategies, document ingestion (Docling, LlamaParse), production pipelines
tags: [docling, llamaparse, rag, vector-db]
timestamp: 2026-08-15
---

From first RAG build to production: pattern catalogs, agentic RAG, and the document-ingestion layer (Docling, LlamaParse) that feeds clean chunks into retrieval.
