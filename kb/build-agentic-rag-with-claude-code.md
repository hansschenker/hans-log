...
description: four-layer codebase RAG pipeline in Claude Code; ~10x less token burn
resource: https://www.youtube.com/watch?v=j0D-i_O_cPw
tags: [rag, agentic, claude]
...
Part of: [RAG](./rag.md) · [Claude Code](./claude-code.md) · [AI Engineering](./ai-engineering.md)
