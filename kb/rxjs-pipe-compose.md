...
description: Point-Free Composition in RxJS FP Architecture — currying, point-free style, hybrid FP-RxJS case study (NotebookLM)
resource: D:\Learning-Local-Hanss\Rxjs-Fp
...
- **Not used here:** `rxjs-fp-mindmap-markdown.md` and `rxjs-fp-style.txt`/`rxjs-fp.txt` in the same
  dir are about the [rxjs-fp — A Functional-Style RxJS Built From Scratch](./rxjs-fp.md) project itself, not this pipe/compose topic — see Notes below

## Notes

- The same directory (`Rxjs-Fp`) now holds two distinct bodies of material: the original
  [rxjs-fp — A Functional-Style RxJS Built From Scratch](./rxjs-fp.md) project session log (2026-08-05) and this newer, general-purpose pipe/compose
  ...
  that belongs as a supplement to [rxjs-fp — A Functional-Style RxJS Built From Scratch](./rxjs-fp.md), not to this note.
- [rxjs-fp — A Functional-Style RxJS Built From Scratch](./rxjs-fp.md)'s Key Concepts already states the terse version of the pipe/compose distinction
...
- [rxjs-fp — A Functional-Style RxJS Built From Scratch](./rxjs-fp.md) — the project this composition pattern applies to; shares the curried/`pipe`/
  `compose` vocabulary but at project-architecture scale rather than a single pattern
- [RxJS Operator Renaming — The Suffix Grammar](./rxjs-operator-renaming.md) — the sibling composition thesis (curried roots × boundary
